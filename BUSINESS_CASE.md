...
2.  **Fase 2: B2B (La Empresa / CRM):** 
    *   **Producto:** Integración con el CRM corporativo (HubSpot/Salesforce). Se gestionan tres escenarios de uso según la adopción y comodidad de los vendedores:
        *   *Escenario A (Automatizado - Rep sube ZIP):* El vendedor sube su ZIP a su monedero encriptado. El sistema cruza de forma segura (semáforo) las conexiones con las cuentas objetivo del CRM corporativo.
